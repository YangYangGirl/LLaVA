...
def main(args):
    ...
    for image_path in tqdm(image_paths):
        ...
        image_file = os.path.join("/mnt/petrelfs/yangyang/codes/SEED-Bench/data/seed_bench_image", image_path)
        image = load_image(image_file)
        image_tensor = image_processor.preprocess(image, return_tensors='pt')['pixel_values'].half().cuda()

        inp = "user: Provide a detail description of the given image."
